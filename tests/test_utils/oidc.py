...
class FakeOidcServer:
    ...
    def patch_homeserver(self, hs: HomeServer) -> AbstractContextManager[Mock]:
    ...
    def id_token_override(self, overrides: dict) -> AbstractContextManager[dict]:
    ...
    def buggy_endpoint(
        ...
        *,
        ...
        token: bool = False,
        userinfo: bool = False,
    ) -> AbstractContextManager[dict[str, Mock]]:
