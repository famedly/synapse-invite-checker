...
class MessageTimestampTestCase(ModuleApiTestCase):
    ...
    def test_can_find_last_message_timestamp(self) -> None:
        ...
        def send_message_and_get_timestamp(room, message, tok) -> None:
        ...
        send_message_and_get_timestamp(room_id, "Message 1", tok=self.access_token_a)
        self.helper.send(room_id, "Message 2", tok=self.access_token_a)

        send_message_and_get_timestamp(room_id, "Message 3", tok=self.access_token_a)

        send_message_and_get_timestamp(room_id, "Message 4", tok=self.access_token_b)
        ...
        send_message_and_get_timestamp(room_id, "Message 10", tok=self.access_token_b)
