...
modules:
  - module: "synapse_invite_checker.InviteChecker"
    config:
        ...
        override_public_room_federation: true or false, # Allows overriding the `m.federate` setting when creating a public room to prevent federation. Default is "true", disable with "false"
```
### Duration Parsing
